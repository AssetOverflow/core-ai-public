# CORE Documentation Navigation Hub

This is the central index of all public-facing documentation for the CORE architecture.
...
| [Architecture Overview](Architecture_Overview.md) | Component hierarchy, data flow, geometric framing |
| [Whitepaper Overview](Whitepaper.md) | Why CORE is architecturally distinct from transformers |
| [Yellowpaper Overview](Yellowpaper.md) | Mathematical motivation: hyperbolic space, Clifford algebra, fiber bundle |
...
| [Roadmap](Roadmap.md) | Phase history and forward milestones |
...
## Access-Gated Documents

The following documents are available to credentialed reviewers upon request (see [SECURITY.md](../SECURITY.md)):
