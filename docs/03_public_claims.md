...
- CORE demonstrated transfer to related tasks.
...
> Public summaries report sanitized benchmark evidence without disclosing implementation-level mechanisms.
...
> Certain details are withheld pending IP review and commercialization strategy.

Avoid:

> The secret sauce is hidden.
...
Public communication should invite scrutiny without giving away the mechanism.
